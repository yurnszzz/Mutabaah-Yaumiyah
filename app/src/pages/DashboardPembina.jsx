...
import {
  ...
  getGrupRekap as apiGetGrupRekap,
  isApiConfigured
} from '../services/api'
import {
  Users, BarChart3, ChevronRight, Loader2,
  CheckCircle, XCircle, Clock, UserCheck, Activity, Percent, TrendingUp
} from 'lucide-react'
    ...
    try {
      if (isApiConfigured() && grupId) {
        ...
        setMembers([
          ...
          { user_id: 'u3', nama: 'Budi Santoso', tingkatan: 'madya', sudah_isi: true, persen_rata_rata: 72, streak_current: 3 },
          ...
          <div className="admin-actions">
            <button className="admin-action-btn" onClick={() => navigate('/anggota')}>
              ...
              <div className="admin-action-btn__content">
                ...
                <p className="admin-action-btn__desc">Info lengkap seluruh anggota</p>
              </div>
